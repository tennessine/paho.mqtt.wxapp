...
Paho.MQTT = (function(wx) {
    ...
    ClientImpl.prototype.restore = function(key) {
        var value = wx.getStorageSync.getItem(key);
            ...
            switch (wireMessage.type) {
                case MESSAGE_TYPE.CONNACK:
                    ...
                    if (this.connectOptions.cleanSession) {
                        for (var key in this._sentMessages) {
                            ...
                            wx.removeStorageSync.removeItem("Sent:" + this._localKey + sentMessage.messageIdentifier);
                        }
                        this._sentMessages = {};

                        for (var key in this._receivedMessages) {
                            var receivedMessage = this._receivedMessages[key];
                            wx.removeStorageSync.removeItem("Received:" + this._localKey + receivedMessage.messageIdentifier);
                        }
                        this._receivedMessages = {};
                    }
                ...
                case MESSAGE_TYPE.PUBACK:
                    ...
                    if (sentMessage) {
                        ...
                        wx.removeStorageSync.removeItem("Sent:" + this._localKey + wireMessage.messageIdentifier);
                        if (this.onMessageDelivered)
                ...
                case MESSAGE_TYPE.PUBREL:
                    ...
                    wx.removeStorageSync.removeItem("Received:" + this._localKey + wireMessage.messageIdentifier);
